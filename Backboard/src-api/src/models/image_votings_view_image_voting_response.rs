...
pub struct ImageVotingsViewImageVotingResponse {
    ...
    pub aspects: Option<Option<Vec<models::ImageVotingsViewImageVotingResponseImageVotingAspect>>>,
...
impl ImageVotingsViewImageVotingResponse {
    pub fn new() -> ImageVotingsViewImageVotingResponse {
