...
pub struct UsersViewUserResponse {
    ...
    #[serde(rename = "lastOnlineAt", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub user_groups: Option<Option<Vec<models::UsersViewUserResponseUserGroup>>>,
...
impl UsersViewUserResponse {
    pub fn new() -> UsersViewUserResponse {
