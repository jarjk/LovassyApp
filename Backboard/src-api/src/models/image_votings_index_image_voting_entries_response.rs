...
pub struct ImageVotingsIndexImageVotingEntriesResponse {
    ...
    pub user: Option<Box<models::ImageVotingsIndexImageVotingEntriesResponseUser>>,
...
impl ImageVotingsIndexImageVotingEntriesResponse {
    pub fn new() -> ImageVotingsIndexImageVotingEntriesResponse {
