...
pub struct ImageVotingsUpdateImageVotingRequestBody {
    #[serde(rename = "name")]
    pub name: String,
    ...
    pub aspects: Vec<models::ImageVotingsUpdateImageVotingRequestBodyImageVotingAspect>,
    #[serde(rename = "active")]
    pub active: bool,
