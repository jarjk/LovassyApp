...
pub struct ImageVotingsCreateImageVotingResponse {
    ...
    pub aspects: Option<Option<Vec<models::ImageVotingsCreateImageVotingResponseImageVotingAspect>>>,
...
impl ImageVotingsCreateImageVotingResponse {
    pub fn new() -> ImageVotingsCreateImageVotingResponse {
