...
pub struct ShopIndexOwnOwnedItemsResponseProduct {
    ...
    pub inputs: Option<Option<Vec<models::ShopIndexOwnOwnedItemsResponseInput>>>,
...
impl ShopIndexOwnOwnedItemsResponseProduct {
    pub fn new() -> ShopIndexOwnOwnedItemsResponseProduct {
