...
pub struct ShopUpdateProductRequestBody {
    ...
    pub user_limit: i32,
    #[serde(rename = "inputs")]
    pub inputs: Vec<models::ShopUpdateProductRequestBodyInput>,
