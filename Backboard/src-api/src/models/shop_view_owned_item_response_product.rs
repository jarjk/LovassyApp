...
pub struct ShopViewOwnedItemResponseProduct {
    ...
    pub inputs: Option<Option<Vec<models::ShopViewOwnedItemResponseProductInput>>>,
...
impl ShopViewOwnedItemResponseProduct {
    pub fn new() -> ShopViewOwnedItemResponseProduct {
